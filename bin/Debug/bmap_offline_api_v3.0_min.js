...
(function() {
    ...
    z.R.ja = function(a) {
        ...
        if (a == (c.ma && !c.DD ? b.body : b.documentElement))
            return f;
        if (a.getBoundingClientRect) {
            ...
            do {
                ...
                g = g.offsetParent
            } while (g && g != a);if (c.opera > 0 || c.qL > 0 && e(a, "position") == "absolute")
    ...
    z.VJ = function() {
        function a(a) {
            ...
            this.YJ = this.qk ? "touchstart" : "mousedown",
            this.xC = this.qk ? "touchmove" : "mousemove",
            this.wC = this.qk ? "touchend" : "mouseup",
            this.fh = t,
            this.Et = this.Dt = 0,
            this.element.addEventListener(this.YJ, this, t),
        ...
        a.prototype = {
            ...
            move: function(a) {
                ...
                if (10 < Math.abs((this.qk ? a.touches[0].clientX : a.clientX) - this.Dt) || 10 < Math.abs(c - this.Et))
                    this.fh = p
            },
            end: function(a) {
                oa(a);
                this.fh || (a = document.createEvent("Event"),
                a.initEvent("tap", t, p),
    ...
    z.extend(Oa.prototype, {
        ...
        yg: function(a, b) {
            ...
            a !== this.Va)) {
                ...
                c && (c = this.Rb(c, this.Bc),
                this.Wj(this.width / 2 - c.x, this.height / 2 - c.y, this.Ib(c, this.Bc), p));
        ...
        pf: function(a) {
            ...
            if (a instanceof J)
                ...
                if (b.Db === Sa) {
                    ...
                    var e = this.QG();
                    e.ot(function(c) {
                        0 === e.am() && 2 === e.Ma.result.type && (b.pf(c.mk(0).point),
                        Sa.ik(a) && b.uE(a))
                    });
                    e.search(a, {
                        log: "center"
        ...
        PQ: function(a, b) {
            for (var c = this.va(), e = b.margins || [10, 10, 10, 10], f = b.zoomFactor || 0, g = e[1] + e[3], e = e[0] + e[2], i = c.aj(), k = c = c.Xh(); k >= i; k--) {
                var m = this.va().dc(k);
                if (a.TE().lng / m < this.width - g && a.TE().lat / m < this.height - e)
                    break
            }
            k += f;
            k < i && (k = i);
        ...
        vs: function(a, b) {
            ...
            if (!a || !a instanceof hb && 0 === a.length || a instanceof hb && a.lj())
                return c;
            var e = [];
            a instanceof hb ? (e.push(a.Lf()),
            e.push(a.Se())) : e = a.slice(0);
            for (var b = b || {}, f = [], g = 0, i = e.length; g < i; g++)
                f.push(this.Pc.bi(e[g], this.Vb));
            e = new hb;
        ...
        cX: x("Bd"),
        hu: function() {
            for (var a = this.$.gE; a < D.Wq.length; a++)
                D.Wq[a](this);
            this.$.gE = a
        },
        uE: function(a) {
        ...
        eB: function(a, b) {
            ...
            a.tag = b;
            a instanceof kb && (this.Ah[b][a.ea] = a,
            a.xa(this));
            var c = this;
        ...
        GZ: function(a) {
            ...
            window.cb = function(a) {
                if (0 === a.status) {
                    3 === a.data.style.length ? (window.bmap_baseFs || (window.bmap_baseFs = a.data.style),
                    window.Kp = a.data.style[2]) : window.Kp = a.data.style;
        ...
        eL: function(a) {
            a ? this.Ir && this.Ir.xf === a || (this.Tf(this.Ir),
            this.Ir = new pb({
                geotableId: a
            }),
        ...
        LE: function(a, b) {
            ...
            for (var g = 0, i; i = a[g]; g++)
                if (!this.SX(i) && (window.qh = this.lX(i, window.qh),
                this.TX(i, b))) {
                    if (("land" === i.featureType || "all" === i.featureType || "background" === i.featureType) && "string" === typeof i.elementType && ("geometry" === i.elementType || "geometry.fill" === i.elementType || "all" === i.elementType) && i.stylers)
                        if (i.stylers.color && (window.La[b].bmapLandColor = i.stylers.color,
                        window.La[b].wL = p,
                        window.bmapLandColor = i.stylers.color),
                        i.stylers.visibility && "off" === i.stylers.visibility)
                            window.La[b].bmapLandColor = "#00000000",
                            window.La[b].wL = p,
                    ...
                    if ("railway" === i.featureType && "string" === typeof i.elementType && i.stylers) {
                        ...
                        window.La[b].bmapRailwayFillColor = i.stylers.color,
        ...
        RN: function(a, b) {
            window.Tt[b] = a;
            if (!window.qh[b])
                for (var c = this.Db.aj(), e = this.Db.Xh(); c <= e; c++)
                    window.qh[c] || (window.Tt[c] = a)
        },
        ZE: function(a) {
            if (!window.qh[a])
                for (var b = this.Db.aj(), c = this.Db.Xh(); b <= c; b++)
                    window.qh[b] || (window.La[b] || (window.La[b] = {}),
                    window.La[b].bmapLandColor = window.La[a].bmapLandColor,
                    window.La[b].bmapRailwayFillColor = window.La[a].bmapRailwayFillColor,
    ...
    function xb(a) {
        var b = eb();
        b >= a.fz ? ($a(a.m.za) && a.m.za(a.m.$b(1)),
        $a(a.m.finish) && a.m.finish(),
        0 < a.Wf.length && (b = a.Wf[0],
        b.Wf = [].concat(a.Wf.slice(1)),
        b.start())) : (a.Nx = a.m.$b((b - a.ju) / a.m.duration),
        $a(a.m.za) && a.m.za(a.Nx),
        a.NE || (a.pr = setTimeout(function() {
            xb(a)
        }, 1E3 / a.m.Hc)))
    }
    ...
    void function(a, b, c) {
            ...
            if (!B || !B.no) {
                ...
                y.prototype.start = y.prototype.create = function(a) {
                    if (!this.xJ) {
                        ...
                        this.xJ = new Date;
                        for (this.as("create", this); a = this.XI.shift(); )
                            v.apply(this, a)
                    }
                }
                ;
        ...
        void function(a, b, c) {
            ...
            if (n && n.kh && m() < n.kh) {
                var w = c.alog.XE("monkey"), y, n = a.screen, A = b.referrer;
                w.set("ver", 5);
                w.set("pid", 241);
    ...
    ;function pa(a, b) {
        if (/^http/.test(a)) return;//添加屏蔽AK验证码
    ...
    z.object.extend(K, {
        ...
        jZ: function(a, b) {
            ...
            c.Ke = this.tj.Bp;
            for (var f = 0, g = c.nu.length; f < g; f++)
                c.nu[f]();
            c.nu.length = 0
        },
        iJ: function(a, b) {
            ...
            c.timeout = setTimeout(function() {
                c.Pd.il[a].Ke != c.tj.Bp ? (c.remove(a),
                c.load(a, b)) : clearTimeout(c.timeout)
            }, c.tF.wT)
        },
        lb: function(a) {
            this.Pd.il[a] || (this.Pd.il[a] = {},
            this.Pd.il[a].Ke = this.tj.BF,
            this.Pd.il[a].nu = []);
            return this.Pd.il[a]
        },
        remove: function(a) {
        ...
        wU: function(a, b) {
            for (var c = this.Pd.qv, e = p, f = 0, g = c.length; f < g; f++)
                "" == c[f].UD && (c[f].VL == a ? c[f].UD = b : e = t);
            e && this.XJ()
        },
        XJ: function() {
    ...
    function kb(a, b) {
        ...
        b = b || {},
        this.Pg = b.text || "",
        this.Wu = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5],
        this.YA = b.userData || s,
        this.Ch = b.minZoom || s,
        this.Cf = b.maxZoom || s)
    }
    kb.ea = 0;
    ...
    z.extend(Ub.prototype, {
        ...
        uc: function(a) {
            if (this.p1 || !Za(a) || isNaN(a) || a < Wb || 3 < a)
        ...
        show: function() {
            this.Sa != p && (this.Sa = p,
            this.P && z.R.show(this.P))
        },
        aa: function() {
            this.Sa != t && (this.Sa = t,
            this.P && z.R.aa(this.P))
        },
    ...
    z.object.extend(fc.prototype, {
        ...
        removeItem: function(a) {
            if (a && "menuitem" == a.Mb) {
                for (var b = 0, c = this.Aa.length; b < c; b++)
                    ...
                    c--);
                b = 0;
                for (c = this.Ef.length; b < c; b++)
                    this.Ef[b] === a && (this.Ef[b].remove(),
                    this.Ef.splice(b, 1),
                    c--)
            }
        },
        ...
        jE: function(a) {
            if (this.De[a]) {
                for (var b = 0, c = this.Aa.length; b < c; b++)
                    this.Aa[b] && ("divider" == this.Aa[b].Mb && this.Aa[b].Aj == a) && (this.Aa.splice(b, 1),
                    c--),
    ...
    function hb(a, b) {
        ...
        a && (this.Al = new J(a.lng,a.lat),
        this.ll = new J(b.lng,b.lat),
        this.Le = a.lng,
        this.Xd = a.lat,
        this.Ge = b.lng,
        this.Vd = b.lat)
    ...
    z.object.extend(hb.prototype, {
        ...
        Ds: function(a) {
            if (!(a instanceof hb) || Math.max(a.Le, a.Ge) < Math.min(this.Le, this.Ge) || Math.min(a.Le, a.Ge) > Math.max(this.Le, this.Ge) || Math.max(a.Xd, a.Vd) < Math.min(this.Xd, this.Vd) || Math.min(a.Xd, a.Vd) > Math.max(this.Xd, this.Vd))
                return s;
    ...
    z.extend(oc.prototype, {
        ...
        Re: x("na"),
        Fm: function(a, b) {
            b && this.na[a] && (this.af.length = 0,
            this.na[a] = new J(b.lng,b.lat),
            this.th())
        },
    ...
    function sc(a, b, c, e) {
        ...
        this.aK = e ? !!e : t,
        this.Uc = [],
        this.h_ = a instanceof rc ? a : s,
        this.KH = b === l ? p : !!(b.indexOf("%") + 1),
        this.Nj = isNaN(parseFloat(b)) ? 1 : this.KH ? parseFloat(b) / 100 : parseFloat(b),
        this.LH = !!(c.indexOf("%") + 1),
        this.repeat = c != l ? this.LH ? parseFloat(c) / 100 : parseFloat(c) : 0)
    }
    ;function tc(a, b) {
        z.lang.Ga.call(this);
        this.content = a;
        ...
        this.K = {
            ...
            BB: b.collisions || [[10, 10], [10, 10], [10, 10], [10, 10]],
            wX: t,
            yY: b.onClosing || ea(p),
            UJ: t,
    ...
    ib.prototype.ad = function(a) {
        ...
        this.map.$.cl = a,
        a.sb = this,
        z.lang.Ga.call(a, a.ea))
    }
    ;
    ib.prototype.Xc = function() {
        this.map && this.map.$.cl && (this.map.$.cl.Sa = t,
        z.lang.rw(this.map.$.cl.ea),
        this.map.$.cl = s)
    }
    ;
    function uc(a, b) {
    ...
    z.extend(Fc.prototype, {
        ...
        Fm: function(a, b) {
            this.Qn[a] && (this.Qn[a] = new J(b.lng,b.lat),
            this.na[a] = new J(b.lng,b.lat),
            0 == a && !this.na[0].oc(this.na[this.na.length - 1]) && (this.na[this.na.length - 1] = new J(b.lng,b.lat)),
            this.th())
        },
        Re: function() {
            var a = this.Qn;
    ...
    z.extend(Jc.prototype, {
        ...
        vf: function() {
            this.tk--;
            var a = this;
            this.yD && (this.map.dispatchEvent(new Q("onfirsttileloaded")),
            this.yD = t);
            0 == this.tk && (this.Bi && (clearTimeout(this.Bi),
            this.Bi = s),
            this.Bi = setTimeout(function() {
                if (a.tk == 0) {
        ...
        KK: function(a, b, c) {
            ...
            for (e = this.Be.length; n < e; n++)
                ...
                q.left = v + "px",
                q.top = w + "px",
                o.jn || this.QE.push([C, k, o])) : (0 < this.Oe.length ? (o = this.Oe.shift(),
                ...
                q.width = f + c + "px",
                q.height = f + c + "px",
                this.XX() && (q.WebkitTransform = "scale(1.001)"),
        ...
        WZ: function(a, b, c, e) {
            ...
            m && m.Jb ? (yb(m.Jb, b),
            e && (e = new R(a[0],a[1]),
            g = this.map.U.we ? this.map.U.we.style : "normal",
            e = c.getTilesUrl(e, a[2], g),
            m.loaded = t,
            Pc(m, e)),
            m.loaded ? this.vf() : Qc(m, function() {
                f.vf()
            })) : (m = this.Si[i]) && m.Jb ? (c.hc.insertBefore(m.Jb, c.hc.lastChild),
            this.rg[i] = m,
            yb(m.Jb, b),
            e && (e = new R(a[0],a[1]),
            g = this.map.U.we ? this.map.U.we.style : "normal",
        ...
        Rf: function(a) {
            if (!this.map.U.Xi) {
                ...
                if (b.map.va() == Sa)
                    K.load("coordtrans", function() {
                        b.map.Vb || (b.map.Vb = Sa.ik(b.map.Tg),
                        b.map.$v = Sa.mK(b.map.Vb));
                        b.rH()
                    }, p);
                else {
                    if (a && a)
            ...
            for (var k = 0; k < c; k++) {
                ...
                if (m.Tv) {
                    ...
                    if (a) {
                        var o = n;
                        if (o && o.childNodes)
                            for (var q = o.childNodes.length, v = q - 1; 0 <= v; v--)
                                q = o.childNodes[v],
                                o.removeChild(q),
                                q = s
                    }
                ...
                if (!m.V0 && !(m.gx && !this.map.Nd() || m.pL && this.map.Nd())) {
                    ...
                    var C = this.rg, A = -this.VI.lng / w, B = this.VI.lat / w, g = [Math.ceil(A), Math.ceil(B)], w = e.ka(), F;
                    for (F in C) {
                        var E = C[F]
                          , G = E.info;
                    ...
                    m.hc && (m.hc.style.left = Math.ceil(A + C) - g[0] + "px",
                    m.hc.style.top = Math.ceil(B + E) - g[1] + "px",
                    m.hc.style.WebkitTransform = "translate3d(0,0,0)");
                    A = [];
                    for (e.$A = []; v < y; v++)
                        for (B = o; B < f; B++)
                            A.push([v, B]),
        ...
        Tf: function(a) {
            ...
            if (a.gx)
                for (var b = 0, c = this.xg.length; b < c; b++)
                    a == this.xg[b] && this.xg.splice(b, 1);
            else {
                b = 0;
                for (c = this.Uf.length; b < c; b++)
                    a == this.Uf[b] && this.Uf.splice(b, 1)
            }
            a.remove()
        },
        wg: function() {
        ...
        this.Jb.onload = function() {
            ...
            if (i.om) {
                ...
                if (i.Jb && !Ab(i.Jb) && f.hc) {
                    ...
                    if (z.ga.ma <= 6 && z.ga.ma > 0 && i.vI)
                        i.Jb.style.cssText = i.Jb.style.cssText + (';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + i.src + '",sizingMethod=scale);')
                }
                var c = a.fE - a.oU, e;
                for (e in b) {
                    if (c <= 0)
    ...
    z.extend(Mc.prototype, {
        ...
        remove: function() {
            this.hc && this.hc.parentNode && (this.hc.innerHTML = "",
            this.hc.parentNode.removeChild(this.hc));
            delete this.hc
        },
        Ks: x("F_"),
        getTilesUrl: function(a, b) {
            if (this.map.va() !== ab && this.map.va() !== Va)
                var c = this.map.oh.Uv(a.x, b).Ol;
            var e = "";
            this.Te.tileUrlTemplate && (e = this.Te.tileUrlTemplate.replace(/\{X\}/, c),
            e = e.replace(/\{Y\}/, a.y),
            e = e.replace(/\{Z\}/, b));
            return e
        },
    ...
    pb.prototype.getTilesUrl = function(a, b) {
        ...
        f.aF || (f = (1E5 * Math.random()).toFixed(0),
        c += "&timeStamp=" + f);
                ...
                for (var a = a[6], k = 0; k < i.length; k++) {
                    ...
                    if (n && n.length)
                        for (var o = i[k][1], q = 0; q < o.length; q++) {
                            var v = o[q][1];
                            f.Nc(v[0], c) && (v["cache" + c] || (v["cache" + c] = f.um(v[1], c, e, a)),
                            v = v["cache" + c],
                            f.M.Vn(b.canvas.id, v, {
                                type: "polygon",
                                Ub: m,
                                style: n
                            }),
        ...
        EV: function(a, b, c, e) {
            ...
            if (!c.Ub || !(6 < e && (71013 === c.Ub || 71012 === c.Ub || 71011 === c.Ub) || 6 === e && (71011 === c.Ub || 71012 === c.Ub) || 5 === e && (71011 === c.Ub || 71013 === c.Ub) || 5 > e && (71012 === c.Ub || 71013 === c.Ub))) {
                ...
                for (var e = 2, f = b.length; e < f; e += 2)
                    a.lineTo(b[e], b[e + 1]);
                a.closePath();
                c.borderWidth && (a.strokeStyle = c.co,
                ...
                for (var a = a[6], i = 0; i < g.length; i++) {
                    ...
                    if (m && m.length && m[0].borderWidth)
                        for (var n = g[i][1], o = 0; o < n.length; o++) {
                            var q = n[o][1];
                            f.Nc(q[0], c) && (q["cache" + c] || (q["cache" + c] = f.um(q[1], c, e, a)),
                            q = q["cache" + c],
        ...
        FV: function(a, b, c, e) {
            ...
            if (!(c < e.filter)) {
                ...
                for (var c = 2, f = b.length; c < f; c += 2)
                    a.lineTo(b[c], b[c + 1]);
                a.closePath();
                e.borderWidth && (a.strokeStyle = e.co,
    ...
    var gd = {
        parse: function(a, b, c, e, f) {
            for (var g = e.M, i = g.ka(), k = Math.pow(2, 18 - i), m = g.Pc.bi(g.Bb()), n = m.lng, o = m.lat, m = g.Hb(), q = m.width, v = m.height, m = [], w = 0; w < a.length; w++) {
                ...
                for (var B = (A[0] * c * k - n) / k + q / 2, C = (o - (A[1] + 1) * c * k) / k + v / 2, F = 0; F < a[w].length; F++)
                    a[w][F].vL ? this.wM(a[w][F].vL, A, e, b, c, B, C, i, k, q, v, y) : a[w][F].yX ? this.wM(a[w][F].yX, A, e, b, c, B, C, i, k, q, v, y, p, window.n3) : this.IY(a[w][F].bY, A, e, b, c, B, C, i, k, q, v, y, f);
                m.push(y)
            }
            ...
            for (w = 0; w < a.length; w++)
                if (c = a[w],
                !c.Fs)
                    if (F = [c.Pf, c.Qf, c.Pf, c.fi, c.ei, c.fi, c.ei, c.Qf, c.Pf, c.Qf],
                    c.style && g.Vn("poi", F, {
                        type: "polygon",
                        Ub: c.style.Ub,
                        style: c.style
                        ...
                        if (c.ue)
                            if (F) {
                                ...
                                this.Ur(b, c, e, F, function(a) {
                                    for (var c = 0; c < a.rf.length; c++)
                                        E.OJ(b, a.rf[c].$d, a.rf[c].ae, a.rf[c].text, a.style, e)
                                })
                            } else
                                this.Ur(b, c, e);
                        if (c.style && !F)
                            for (F = 0; F < c.rf.length; F++)
                                this.OJ(b, c.rf[F].$d, c.rf[F].ae, c.rf[F].text, c.style, e)
                    } else if ("line" === c.type)
                        for (F = 0; F < c.eO.length; F++)
                            f = c.eO[F],
                            gd.AV(b, f.$d, f.ae, f.TT, f.cO, f.width, f.height, c.style, e);
            return m
        },
        ...
        LJ: function(a, b, c, e, f) {
            ...
            if (b.style && 62203 === q) {
                for (var v = n = m = 0; v < b.rf.length; v++)
                    m < b.rf[v].width && (m = b.rf[v].width),
                    n += 20;
                m = Math.ceil(m) + 10
            }
            e && 519 === q && (o = t);
            m !== s && n !== s ? this.DV(a, b, c, 8, m, n) : e && o ? (m = Math.ceil(b.rf[0].width) + 6,
            this.wV(a, b, c, 12, m, c.height / 2)) : a.drawImage(c, i, k, g.width, g.height);
            f && f(b)
        },
        ...
        VY: function(a, b) {
            ...
            for (g = c.length; f < g; f++) {
                ...
                for (k = f + 1; k < g; k++)
                    i = c[k],
                    m.ei - e < i.Pf || (m.Pf > i.ei - e || m.fi - e < i.Qf || m.Qf > i.fi - e) || m.YI.push(k)
            }
            f = 0;
            for (g = c.length; f < g; f++)
                if (k = c[f],
    ...
    function ld(a, b) {
        if ("tielu" === a || "tielu_0" === a) {
            if ("off" === window.La[b].bmapRailwayVisibility)
                return [];
            var c = "#ffffff"
              , e = "#949494";
    ...
    var md = {
        drawLink: function(a, b, c, e, f) {
            var g = a[1];
            g && (a = a[6],
            this.NN(g, c, e, b, a, f, p),
            this.NN(g, c, e, b, a, f, t))
        },
                ...
                if (n && n.length && (!i || n[0].borderWidth))
                    if (!n[0].xo || ld(n[0].xo, b))
                        for (var o = a[k][1], q = 0; q < o.length; q++) {
                            var v = o[q][3];
                            g.Nc(v[0], b) && (v["cache" + b] || (v["cache" + b] = g.um(v[1], b, c, f)),
                            v = v["cache" + b],
                            g.M.Vn(e.canvas.id, v, {
                                type: "polyline",
                                Ub: m,
                                style: n
                            }),
        ...
        BV: function(a, b, c, e, f) {
            c = c[0];
            if (!e && c.xo && ld(c.xo, f))
                this.IV(a, b, c, ld(c.xo, f));
            else {
                a.beginPath();
                a.moveTo(b[0], b[1]);
                for (var f = 2, g = b.length; f < g; f += 2)
                    a.lineTo(b[f], b[f + 1]);
                c.borderWidth && e ? (a.strokeStyle = c.co,
                a.lineCap = hd[c.iU],
                a.lineJoin = id[1],
                a.lineWidth = c.borderWidth / 2,
                a.stroke()) : e || (a.strokeStyle = c.zw,
                a.lineCap = hd[c.WV],
                a.lineJoin = id[1],
                a.lineWidth = c.$J / 2,
                a.stroke())
    ...
    var nd = 3, od = 4, pd = 7, qd = 8, rd = 15, sd = 16, td = {}, ud = {}, vd = {}, wd, xd = {
        3: {
            start: 3,
            Lc: 3
        },
    ...
    yd.prototype = {
        bC: function(a, b, c, e, f, g, i, k, m) {
            ...
            var n = this;
            m || (m = 0);
            if (!(z.km(window.qh) ? window.Kp : window.Tt[f]) && 100 > m)
                setTimeout(function() {
                ...
                17 <= this.M.ka() ? (n.NJ(a, o, f, g, i, c, e),
                b.jn = p) : setTimeout(function() {
                    if (!b.tG) {
                        n.NJ(a, o, f, g, i, c, e);
                        b.jn = p
                    }
        ...
        NJ: function(a, b, c, e) {
            if (a[0])
                for (var f = 0; f < a[0].length; f++) {
                    ...
                    dd.drawGaoqingRoadFill(g, b, c, e, this)) : 18 === i ? "off" !== window.La[c].bmapRoadarrowVisibility && ed.drawArrow(g, b, c, e, Math.pow(2, c - xd[c].Lc), this) : i === qd ? fd.drawHregion(g, b, c, e, this) : 19 === i && md.drawSingleTexture(g, b, c, e, this)
                }
        },
        MJ: function(a, b, c, e, f, g, i) {
            ...
            a.PY = gd.parse(a, c, e, this, f))
        },
        hj: function(a, b, c, e) {
            var f = a + "-" + b + "-" + c;
            if (e)
                return td[f] || (td[f] = this.ng(a, b, c, e)),
                td[f];
    ...
    function Lc(a, b, c) {
        ...
        for (e in c)
            c.hasOwnProperty(e) && (this.XA = this.XA + "&" + e + "=" + c[e]);
        this.Ug = {};
        this.Fr = [];
        this.Ls = 0;
        this.ex = t;
                    ...
                    if (k)
                        for (var m = 0; m < k.length; m++)
                            for (var n = k[m], o = 0; o < n.length; o++)
                                if (a = n[o],
                                !a.Fs && a.As && b > a.Pf && b < a.ei && c > a.Qf && c < a.fi) {
                                    b = a.As;
                                    b = {
                                        type: 9,
                                        name: a.name,
    ...
    fa.To = function(a) {
        ...
        for (k = a.length; b < k; b++) {
            ...
            if (B)
                ...
                C.width = f + "px",
                C.height = f + "px",
                B.jn ? B.PE && B.PE && this.Fr.push(B.PE) : (B.tG = p,
                B.aB = s,
                delete B.aB,
                o.push([n, q, B]));
            else {
        ...
        if (0 === o.length) {
            ...
            e = this.Bd.gs(c);
            f = {};
            for (g = 0; g < this.ow.length; g++)
                i = this.ow[g],
                i = a + "_" + i[0] + "_" + i[1] + "_" + e + "_" + c,
                this.Ug[i] && (f[i] = this.Ug[i],
                this.$E && this.Bv.cC.bC(this.Ug[i].T_, this.Ug[i].m_, this.Ug[i].Ol, this.Ug[i].Am, this.Ug[i].OD, this.Bd.Id(this.Ug[i].OD), this.Bd.XC(this.Ug[i].OD), this.$a.oD));
            this.Ug = f
        } else {
            this.Ls = o.length;
            this.ex = t;
            ...
            if (a) {
                ...
                if (o !== t) {
                    ...
                    if (m.U.uo) {
                        ...
                        k.Bv.cC.bC(a, f, b, c, n, k.Bd.Id(n), k.Bd.XC(n), k.$a.oD),
                        k.$a.DE) {
                            n = [];
                            n.n_ = [b, c, e];
                            if (a[0])
    ...
    z.extend(be.prototype, {
        ...
        XU: function() {
            ...
            if (this.page < this.Sf)
                e = 0 == this.page % this.Sf ? this.page - this.Sf - 1 : this.page - this.page % this.Sf + 1,
                b = e + this.Sf - 1;
            else {
            ...
            this.page > this.Jd - this.Sf && this.page >= this.Sf && (e = this.Jd - this.Sf + 1,
            b = this.Jd);
            for (f = e; f <= b; f++)
                ...
                a.push(e.replace("{temp3}", "BMap.I('" + this.ea + "').toPage(" + f + ");"))));
        ...
        toPage: function(a) {
            a = a ? a : 1;
            "function" == typeof this.eJ && (this.eJ(a),
            this.page = a);
            this.update && this.za()
        }
    });
    ...
    function Ra(a, b) {
        function c() {
            f.m.visible ? ("inter" === f.Ie && f.m.haveBreakId && f.m.indoorExitControl === p ? z.R.show(f.Iz) : z.R.aa(f.Iz),
            this.m.closeControl && this.wf && this.M && this.M.Ua() === this.P ? z.R.show(f.wf) : z.R.aa(f.wf),
            this.m.forceCloseControl && z.R.show(f.wf)) : (z.R.aa(f.wf),
            z.R.aa(f.Iz))
        }
        ...
        this.Lg = [];
        this.Oq = [];
        "cvsRender" == this.Rj || Qa() ? (this.Jj = 90,
        this.Lj = -90) : "cssRender" == this.Rj && (this.Jj = 45,
        this.Lj = -45);
        this.Sq = t;
        var f = this;
        this.zn = function() {
    ...
    z.extend(Ra.prototype, {
        ...
        od: function(a) {
            a && (this.Ha = a,
            a = this.Ha.pitch,
            a > this.Jj ? a = this.Jj : a < this.Lj && (a = this.Lj),
            this.Sq = p,
            this.Ha.pitch = a)
        },
        MZ: function(a, b) {
        ...
        Qc: function(a) {
            ...
            a < Ae && (a = Ae),
            a != this.Kc && (this.Kc = a),
            "cssRender" === this.Rj && this.od(this.Ha))
        },
        KA: function() {
            if (this.M)
                for (var a = this.M.Mw(), b = 0; b < a.length; b++)
                    (a[b]instanceof V || a[b]instanceof uc) && a[b].point && this.Ba.push(a[b])
        },
        xE: ca("M"),
        mt: function(a) {
            this.If = a || "none"
    ...
    function uf(a, b) {
        ...
        c.fa(lf, window);
        c.fa(mf);
        !hf && "none" != c.options.dO && (c.fa("DOMMouseScroll"),
        c.fa("mousewheel"));
    ...
    uf.prototype = {
        ...
        fv: function(a) {
            ...
            this.options.nE ? b.className = this.options.nE + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.qi ? "7" : "2") + "px" : "width:7px;bottom:" + (this.Zh ? "7" : "2") + "px;top:2px;right:1px"),
            b.style.cssText += ";pointer-events:none;" + Xe + "transition-property:opacity;" + Xe + "transition-duration:" + (this.options.VV ? "350ms" : "0") + ";overflow:hidden;opacity:" + (this.options.Ww ? "0" : "1"),
            this.Pm.appendChild(b),
            this[a + "ScrollbarWrapper"] = b,
            b = Pe.createElement("div"),
            this.options.nE || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + Xe + "background-clip:padding-box;" + Xe + "box-sizing:border-box;" + ("h" == a ? "height:100%" : "width:100%") + ";" + Xe + "border-radius:3px;border-radius:3px"),
            ...
            this.options.pi && (b.style.cssText += ";" + Xe + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"),
            this[a + "ScrollbarWrapper"].appendChild(b),
            this[a + "ScrollbarIndicator"] = b),
            "h" == a ? (this.SK = this.TK.clientWidth,
            this.oX = Qe.max(Qe.round(this.SK * this.SK / this.Ox), 8),
            this.nX.style.width = this.oX + "px") : (this.WN = this.XN.clientHeight,
            this.O_ = Qe.max(Qe.round(this.WN * this.WN / this.gp), 8),
            this.N_.style.height = this.O_ + "px"),
            this.EA(a, p)) : this[a + "ScrollbarWrapper"] && (jf && (this[a + "ScrollbarIndicator"].style[Ze] = ""),
        ...
        Rq: function(a, b) {
            this.Nk || (a = this.Mo ? a : 0,
            b = this.Mm ? b : 0,
            this.options.Kk ? this.Ob.style[Ze] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + tf : (a = Qe.round(a),
            b = Qe.round(b),
        ...
        EA: function(a, b) {
            ...
            0 > c ? (this.options.AC || (c = this[a + "ScrollbarIndicatorSize"] + Qe.round(3 * c),
            8 > c && (c = 8),
            this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"),
            c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.AC ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Qe.round(3 * (c - this[a + "ScrollbarMaxScroll"])),
            8 > c && (c = 8),
            this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px",
            c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))),
            this[a + "ScrollbarWrapper"].style[df] = "0",
            this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Ww ? "0" : "1",
            this[a + "ScrollbarIndicator"].style[Ze] = "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + tf)
        },
        GP: function(a) {
            if (a.yQ === p)
                return this.cB = a.target,
                this.yw = Date.now(),
                p;
            if (this.cB && this.yw) {
                if (600 < Date.now() - this.yw)
                    return this.yw = this.cB = s,
                    p
            } else {
            ...
            if ("select" != b && "input" != b && "textarea" != b)
                return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.XY = p,
                a.stopPropagation(),
                a.preventDefault(),
                this.yw = this.cB = s,
                t
        ...
        ov: function(a) {
            ...
            if (this.enabled) {
                ...
                this.w_ = Qe.sqrt(e * e + c * c),
                this.xx = Qe.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.fF) / 2 - this.x,
                this.yx = Qe.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.gF) / 2 - this.y,
                this.options.Yo && this.options.Yo.call(this, a));
                if (this.options.ox && (this.options.Kk ? (c = getComputedStyle(this.Ob, s)[Ze].replace(/[^0-9\-.,]/g, "").split(","),
                e = +(c[12] || c[4]),
                c = +(c[13] || c[5])) : (e = +getComputedStyle(this.Ob, s).left.replace(/[^0-9-]/g, ""),
                c = +getComputedStyle(this.Ob, s).top.replace(/[^0-9-]/g, "")),
                e != this.x || c != this.y))
                    this.options.pi ? this.Yd(qf) : sf(this.nB),
                    this.pj = [],
                    this.Rq(e, c),
                    this.options.vx && this.options.vx.call(this);
                this.Iv = this.x;
                this.Jv = this.y;
                this.Dt = this.x;
                this.Et = this.y;
        ...
        aS: function(a) {
            ...
            if (this.options.zoom && hf && 1 < a.touches.length)
                ...
                this.v_ = Qe.sqrt(f * f + g * g),
                this.Nk = p,
                b = 1 / this.w_ * this.v_ * this.scale,
                b < this.options.Mk ? b = 0.5 * this.options.Mk * Math.pow(2, b / this.options.Mk) : b > this.options.zp && (b = 2 * this.options.zp * Math.pow(0.5, this.options.zp / b)),
                this.Ro = b / this.scale,
                f = this.xx - this.xx * this.Ro + this.x,
                g = this.yx - this.yx * this.Ro + this.y,
                this.Ob.style[Ze] = "translate(" + f + "px," + g + "px) scale(" + b + ")" + tf,
                this.options.rM && this.options.rM.call(this, a);
            else {
                this.gh = b.pageX;
                this.hh = b.pageY;
                if (0 < f || f < this.fe)
                    f = this.options.eo ? this.x + c / 2 : 0 <= f || 0 <= this.fe ? 0 : this.fe;
                if (g > this.mf || g < this.nd)
                    g = this.options.eo ? this.y + e / 2 : g >= this.mf || 0 <= this.nd ? this.mf : this.nd;
                this.XB += c;
                this.YB += e;
                this.Gv = Qe.abs(this.XB);
                this.Hv = Qe.abs(this.YB);
                6 > this.Gv && 6 > this.Hv || (this.options.ND && (this.Gv > this.Hv + 5 ? (g = this.y,
                e = 0) : this.Hv > this.Gv + 5 && (f = this.x,
                c = 0)),
                this.fh = p,
                this.Rq(f, g),
                this.RB = 0 < c ? -1 : 0 > c ? 1 : 0,
                this.SB = 0 < e ? -1 : 0 > e ? 1 : 0,
                300 < i - this.startTime && (this.startTime = i,
                this.Dt = this.x,
                this.Et = this.y),
                this.options.oM && this.options.oM.call(this, a))
            }
        },
        zu: function(a) {
            if (!(hf && 0 !== a.touches.length)) {
                ...
                if (b.Nk)
                    ...
                    e = Math.min(b.options.zp, e),
                    b.Ro = e / b.scale,
                    b.scale = e,
                    b.x = b.xx - b.xx * b.Ro + b.x,
                    b.y = b.yx - b.yx * b.Ro + b.y,
                    b.Ob.style[af] = "200ms",
                    b.Ob.style[Ze] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + tf,
                    b.Nk = t,
                    b.refresh(),
                    b.options.Xo && b.options.Xo.call(b, a);
                else {
                    if (b.fh) {
                        if (300 > k && b.options.ox) {
                            ...
                            if (b.y > b.mf && f > b.mf || b.y < b.nd && f < b.nd)
                                i = {
                                    Fa: 0,
                                    time: 0
                                }
                        ...
                        b.options.At && (g = e - b.Iv,
                        i = f - b.Jv,
                        Qe.abs(g) < b.options.Yx && Qe.abs(i) < b.options.Yx ? b.scrollTo(b.Iv, b.Jv, 200) : (g = b.kI(e, f),
                        e = g.x,
                        f = g.y,
                        c = Qe.max(g.time, c))),
                        b.scrollTo(Qe.round(e), Qe.round(f), c)) : b.options.At ? (g = e - b.Iv,
                        i = f - b.Jv,
                        Qe.abs(g) < b.options.Yx && Qe.abs(i) < b.options.Yx ? b.scrollTo(b.Iv, b.Jv, 200) : (g = b.kI(b.x, b.y),
                        (g.x != b.x || g.y != b.y) && b.scrollTo(g.x, g.y, g.time))) : b.Gn(200)
                    } else {
                        if (hf)
                            if (b.FJ && b.options.zoom)
                                clearTimeout(b.FJ),
                                b.FJ = s,
                                b.options.Yo && b.options.Yo.call(b, a),
                                b.zoom(b.gh, b.hh, 1 == b.scale ? b.options.rV : 1),
                                b.options.Xo && setTimeout(function() {
        ...
        Gn: function(a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.fh && (this.fh = t,
                this.options.vx && this.options.vx.call(this)),
                this.Zh && this.options.Ww && ("webkit" == Se && (this.TK.style[df] = "300ms"),
                this.TK.style.opacity = "0"),
                this.qi && this.options.Ww)
                    "webkit" == Se && (this.XN.style[df] = "300ms"),
                    this.XN.style.opacity = "0"
            } else
        ...
        ET: function(a) {
            ...
            if ("zoom" == b.options.dO) {
                ...
                e < b.options.Mk && (e = b.options.Mk),
                e > b.options.zp && (e = b.options.zp),
                e != b.scale)
                    !b.hy && b.options.Yo && b.options.Yo.call(b, a),
                    b.hy++,
                ...
                e > b.mf ? e = b.mf : e < b.nd && (e = b.nd),
                0 > b.nd && b.scrollTo(c, e, 0)
        },
        AT: function(a) {
            a.target == this.Ob && (this.Yd(qf),
            this.QA())
        },
        QA: function() {
            var a = this, b = a.x, c = a.y, e = Date.now(), f, g, i;
            a.Il || (a.pj.length ? (f = a.pj.shift(),
            f.x == b && f.y == c && (f.time = 0),
            a.Il = p,
            a.fh = p,
            a.options.pi) ? (a.uI(f.time),
            a.Rq(f.x, f.y),
            a.Il = t,
            f.time ? a.fa(qf) : a.Gn(0)) : (i = function() {
                var k = Date.now(), m;
                if (k >= e + f.time) {
                    a.Rq(f.x, f.y);
                    a.Il = t;
        ...
        refresh: function() {
            ...
            if ("string" == typeof this.options.At) {
                ...
                for (b = c.length; a < b; a++)
                    ...
                    e.left += this.fF,
                    e.top += this.gF,
                    this.Ue[a] = e.left < this.fe ? this.fe : e.left * this.scale,
                    this.of[a] = e.top < this.nd ? this.nd : e.top * this.scale
            } else if (this.options.At) {
                for (this.Ue = []; e >= this.fe; )
                    this.Ue[b] = e,
                    e -= this.Rt,
                    b++;
                this.fe % this.Rt && (this.Ue[this.Ue.length] = this.fe - this.Ue[this.Ue.length - 1] + this.Ue[this.Ue.length - 1]);
                b = e = 0;
                for (this.of = []; e >= this.nd; )
                    this.of[b] = e,
                    e -= this.Qm,
                    b++;
        ...
        zoom: function(a, b, c, e) {
            ...
            this.y = this.y > this.mf ? this.mf : this.y < this.nd ? this.nd : this.y,
            this.Ob.style[af] = e + "ms",
            this.Ob.style[Ze] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + tf,
            this.Nk = t)
        }
    };
    function Ye(a) {
    ...
    D.tm(function(a) {
        ...
        a.addEventListener("position_changed", function() {
            a.m.visible && a.m.albumsControl === p && (b ? b.Jx(a.Xb()) : (b = new vf(a.m.albumsControlOptions),
            b.xa(a)))
        });
        a.addEventListener("albums_visible_changed", function() {
            a.m.albumsControl === p ? (b ? b.Jx(a.Xb()) : (b = new vf(a.m.albumsControlOptions),
            b.xa(a)),
            b.show()) : b.aa()
        });
    ...
    z.extend(vf.prototype, {
                ...
                z.V(b, "click", function(a) {
                    if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
                        ...
                        for (var e = b.getElementsByTagName("li"), f = 0, g = e.length; f < g; f++)
                            e[f].childNodes[0].getAttribute("dataindex") === a ? z.R.eb(e[f], "pano_catlogLiActive") : z.R.tc(e[f], "pano_catlogLiActive")
                    }
                });
                var a = O("div")
                  , e = O("a")
        ...
        tl: function(a) {
            this.Pj = a;
            this.m.showCatalog && (0 < this.Di.length ? (Xa() ? this.VU() : this.YU(),
            this.Rc.offsetLeft = 60) : (this.Zr && (this.P.removeChild(this.Zr),
            this.Zr = s,
            this.Rc.bg.style.left = "0px"),
            this.Ai && (this.P.removeChild(this.Ai),
            this.Ai = s),
            this.Rc.offsetLeft = 0));
            var b = this.yW(a);
            Xa() && (this.Di && 0 < this.Di.length && this.m.showExit && this.iz) && (this.Rc.offsetLeft += this.ag.width + 8,
            this.Zr ? this.Zr.innerHTML = this.iz : this.WU());
            this.Ih.innerHTML = b;
            this.Ih.style.width = (this.ag.width + 8) * a.length + 8 + "px";
            a = this.P.offsetWidth;
            b = this.Ih.offsetWidth;
            this.Rc.fs && (b += this.Rc.fs());
            b < a - 2 * this.Rc.ti - this.Rc.offsetLeft ? this.P.style.width = b + this.Rc.offsetLeft + "px" : (this.P.style.width = isNaN(Number(this.m.maxWidth)) === p ? this.m.maxWidth : this.m.maxWidth + "px",
            b < this.P.offsetWidth - 2 * this.Rc.ti - this.Rc.offsetLeft && (this.P.style.width = b + this.Rc.offsetLeft + "px"));
            this.Rc.refresh();
            this.FA = this.Ih.children;
            this.Ih.appendChild(this.Tj);
            this.Tj.style.left = "-100000px";
            a = this.LG(this.W.Xb(), this.d1);
            -1 !== a && this.jp(a)
        },
        GW: function(a) {
        ...
        yW: function(a) {
            for (var b, c, e, f, g = [], i = this.ag.height, k = this.ag.width, m = 0; m < a.length; m++)
                b = a[m],
                recoType = b.recoType,
                e = b.panoId,
                f = b.name,
